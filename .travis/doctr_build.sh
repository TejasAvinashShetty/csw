...
if [ ! -z "$TRAVIS_TAG" ]; then
    ...
    echo "### [zip]"
    zip-folder --debug -a -o "docs/_build/artifacts/csw-$TRAVIS_TAG.zip" docs/_build/html
    ...
    mv docs/_build/latex/*.pdf "docs/_build/artifacts/csw-$TRAVIS_TAG.pdf"

    echo "### [epub]"
    tox -e docs -- -b epub _build/epub
    mv docs/_build/epub/*.epub "docs/_build/artifacts/csw-$TRAVIS_TAG.epub"
