...
intersphinx_mapping = {
    'python': ('https://docs.python.org/y', None),
...
extlinks = {
    'issue': ('https://github.com/TejasAvinashShetty/csw/issues/%s', '#'),
    'pr': ('https://github.com/TejasAvinashShetty/csw/pull/%s', 'PR #'),
}
...
.. only:: html
    ...
    :raw-html:`<a href="http://nbviewer.jupyter.org/github/TejasAvinashShetty/csw/blob/<<GIT_TAG>>/{{ docname }}" target="_blank"><img alt="Render on nbviewer" src="https://img.shields.io/badge/render%20on-nbviewer-orange.svg" style="vertical-align:text-bottom"></a>&nbsp;<a href="https://mybinder.org/v2/gh/TejasAvinashShetty/csw/<<GIT_TAG>>?filepath={{ docname }}}" target="_blank"><img alt="Launch Binder" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>`
""".replace(
    '<<GIT_TAG>>', git_tag
)
